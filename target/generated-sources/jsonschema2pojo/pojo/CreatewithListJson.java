...
public class CreatewithListJson {
     ...
     * 
     */
    public CreatewithListJson() {
    }

    public CreatewithListJson(Integer id, String username, String firstName, String lastName, String email, String password, String phone, Integer userStatus) {
        super();
        this.id = id;
    ...
    public String toString() {
        ...
        sb.append(CreatewithListJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CreatewithListJson) == false) {
            return false;
        }
        CreatewithListJson rhs = ((CreatewithListJson) other);
